...
/** class CarTypeController：Web 控制器，负责接收 HTTP 请求、调用领域服务并构造统一响应。 */
class CarTypeController(
    private val service: CarTypeService,
    ...
    fun create(@RequestBody entity: CarType): ResponseEntity<Response> =
    ...
    fun createBatch(@RequestBody entities: List<CarType>): ResponseEntity<Response> =
    ...
    fun update(@PathVariable id: Long, @RequestBody entity: CarType): ResponseEntity<Response> =
    ...
    fun updateBatch(@RequestBody entities: List<CarType>): ResponseEntity<Response> =
