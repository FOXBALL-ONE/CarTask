...
/** class AccessControlTypeController：Web 控制器，负责接收 HTTP 请求、调用领域服务并构造统一响应。 */
class AccessControlTypeController(
    private val service: AccessControlTypeService,
    ...
    fun create(@RequestBody entity: AccessControlType): ResponseEntity<Response> =
    ...
    fun createBatch(@RequestBody entities: List<AccessControlType>): ResponseEntity<Response> =
    ...
    fun update(@PathVariable id: Long, @RequestBody entity: AccessControlType): ResponseEntity<Response> =
    ...
    fun updateBatch(@RequestBody entities: List<AccessControlType>): ResponseEntity<Response> =
