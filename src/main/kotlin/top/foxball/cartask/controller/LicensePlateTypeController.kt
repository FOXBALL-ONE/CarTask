...
/** class LicensePlateTypeController：Web 控制器，负责接收 HTTP 请求、调用领域服务并构造统一响应。 */
class LicensePlateTypeController(
    private val service: LicensePlateTypeService,
    ...
    fun create(@RequestBody entity: LicensePlateType): ResponseEntity<Response> =
    ...
    fun createBatch(@RequestBody entities: List<LicensePlateType>): ResponseEntity<Response> =
    ...
    fun update(@PathVariable id: Long, @RequestBody entity: LicensePlateType): ResponseEntity<Response> =
    ...
    fun updateBatch(@RequestBody entities: List<LicensePlateType>): ResponseEntity<Response> =
